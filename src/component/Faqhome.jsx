...
const Faqhome = () => {
  ...
  return (
<div className='faq faqhome'>
<div className='desktek destekonlayn destekuzv faqbutton'>
        <p>Faq</p>
                </div>
                <h2>Sizi Maraqlandıran Suallara Cavablar</h2>
      <div className='faqmain faqmainhome'>
